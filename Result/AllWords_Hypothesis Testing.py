...
@author: M.Lee
@file: AllWords_Hypothesis Testing.py
@time: 2018/3/20-2018/5/10
"""
...
for eve_sent in my_corp:
	if my_corp[sent_count][-1]=='?':
		...
		for words_tup in tag_curr_sent:
			...
			if words_tup[1]=='NN' and words_tup[0]!='t' and words_tup[0]!='Yeah' and words_tup[0]!='Hey'and words_tup[0]!='fuck' and words_tup[0]!='s' and words_tup[0]!='m' and words_tup[0]!='don' and words_tup[0]!='re' and words_tup[0]!='Are' and words_tup[0]!='Did':
				NN_count=NN_count+1
			...
			if words_tup[1]=='NNP':
				...
				NNP_Num=NNP_Num+1
				#Possibility.extend([words_tup[1]])
			if words_tup[1]=='JJ':
				JJ_count=JJ_count+1
				JJ_Num=JJ_Num+1
				#Possibility.extend([words_tup[1]])
